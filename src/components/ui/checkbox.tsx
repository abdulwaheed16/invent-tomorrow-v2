  ...
  return (
    <CheckboxPrimitive.Root
      ...
      className={cn(
        ...
        "data-[state=checked]:bg-gradient-to-br data-[state=checked]:from-purple-600 data-[state=checked]:to-pink-600",
        "data-[state=checked]:text-white dark:data-[state=checked]:from-purple-600 dark:data-[state=checked]:to-pink-600",
